...
createdBy.innerHTML = createdBy.innerHTML + " Claudio Aravena";
...
//    1) Crear un elemento 'div' y asignárselo a una variable denominada 'toDoShell'                             ok
 //    2) Asignarle a 'toDoShell' la clase 'toDoShell'    ok
//    3) Crear un elemento 'span' y asignárselo a una variable denominada 'toDoText'       ok
...
function buildToDo(todo, index) {
    ...
    if (todo.complete) { 
        toDoText.setAtributte('class', 'completeText') 
    }
    //else {toDoText.setAttribute('class', '')}
...
function buildToDos(toDos) {
    ...
    // si no funciona el retur, asignar a una variable y retornar
    //return arrToDo
}
...
function displayToDos() {
    ...
    let elementsDiv = buildToDos(toDoItems) //array de toDoShell (elementos html - divs)
    console.log(elementsDiv);
    elementsDiv.forEach(toDoShell => 
